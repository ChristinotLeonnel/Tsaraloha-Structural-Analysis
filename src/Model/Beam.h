...
public:
    Beam() = default;
    Beam(int id, int startNodeId, int endNodeId, double width = 0.30, double height = 0.50);
...
private:
    ...
    int m_startNodeId = 0;
    int m_endNodeId = 0;
    double m_width = 0.30;   // Largeur b de la section en mètres
    double m_height = 0.50;  // Hauteur h de la section en mètres
};
